...
const FileCopyIcon = (props) => {
    return (
        <svg className={`text-gray-800 dark:text-white ${props.className}`} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
